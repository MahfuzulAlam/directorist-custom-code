<?php
if ( ! class_exists( 'ATBDP_Custom_GJSGeoQuery' ) ) {
    class ATBDP_Custom_GJSGeoQuery {
        ...
        public function posts_fields( $sql, $query ) {
            global $wpdb;
            $atbdp_geo_query = $query->get( 'atbdp_geo_query_custom' );
            if ( $atbdp_geo_query ) {
        ...
        public function posts_where( $sql, $query ) {
            ...
            if ( $atbdp_geo_query ) {
                ...
                $new_sql = '( atbdp_geo_query_lat.meta_key = %s AND atbdp_geo_query_lng.meta_key = %s )';

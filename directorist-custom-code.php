...
if ( !class_exists( 'Directorist_Custom_Code' ) ) {
    ...
    final class Directorist_Custom_Code {
        ...
        public function define_constant() {
            ...
            if ( !defined( 'DIRECTORIST_CUSTOM_MAP_VERSION' ) ) {
                define( 'DIRECTORIST_CUSTOM_MAP_VERSION', '1.0.0' );
            }
        ...
        public function enqueue_scripts() {
            ...
            wp_enqueue_script( 'directorist-custom-script', DIRECTORIST_CUSTOM_CODE_URI . 'assets/js/main.js', [ 'jquery' ], '1.0', true );
        }
        ...
        public function enqueue_styles() {
            // Replace 'your-plugin-name' with the actual name of your plugin's folder.
            wp_enqueue_style( 'directorist-custom-style', DIRECTORIST_CUSTOM_CODE_URI . 'assets/css/main.css', [], '1.0' );
        }
        ...
        public function directorist_template( $template, $field_data ) {
            ...
            if ( $this->template_exists( $template ) ) {
                $template = $this->get_template( $template, $field_data );
            }

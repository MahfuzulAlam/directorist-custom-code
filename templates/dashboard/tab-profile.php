...
$nid = get_user_meta( get_current_user_id(),'_nid', true );
$nid = $nid && !empty( $nid ) ? $nid: '';
?>
				...
				<div class="directorist-card directorist-user-profile-box">
					...
					<div class="directorist-card__body">
						...
						<div class="directorist-user-info-wrap">
                            ...
                            <div class="directorist-user-nid">
                                <div class="directorist-form-group">
                                    <label for="nid"><?php esc_html_e( 'Número de identificación (Cédula)', 'directorist' ); ?></label>

                                    <input class="directorist-form-element" id="nid" type="text" name="user[nid]" value="<?php echo esc_attr( $nid ); ?>" disabled="disabled">
                                </div>
                            </div>

					...
					<div class="directorist-card__body">
						...
						<div class="directorist-user-info-wrap">
							...
							<div class="directorist-user-socials">
								...
								<div class="directorist-form-group twitter-square-icon">

									<label for="twitter"><span class="directorist-social-icon"><?php directorist_icon( 'fab fa-twitter-square' ); ?></span><?php esc_html_e( 'Twitter', 'directorist' ); ?></label>
								...
								<div class="directorist-form-group">
									...
									<input id="instagram" class="directorist-form-element" type="url" name="user[instagram]" value="<?php echo esc_attr( get_user_meta( get_current_user_id(), 'atbdp_instagram', true ) ); ?>" placeholder="<?php esc_attr_e( 'Enter instagram url', 'directorist' ); ?>">

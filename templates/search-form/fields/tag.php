...
$in_tag = !empty( $_REQUEST['in_tag'] ) ? array_map( 'sanitize_text_field', wp_unslash( $_REQUEST['in_tag'] ) ) : [];
...
?>
    ...
    <input type="hidden" id="directorist_tag_source" value="<?php echo $tag_source; ?>" />
</div>
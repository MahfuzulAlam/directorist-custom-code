<?php
/**
 * Search form custom radio field.
 *
				...
				<?php foreach ( $directorist_custom_code_options as $directorist_custom_code_option ) : ?>
					...
					<div class="directorist-radio directorist-radio-circle">
						<input
							...
							<?php checked( $value === $directorist_custom_code_option['option_value'] ); ?>
						>
						<label class="directorist-radio__label" for="<?php echo esc_attr( $directorist_custom_code_unique_id ); ?>">

    ...
    <div class="directorist-search-modal__contents__body">
        <?php if ( ! empty( $fields ) ) :
            foreach ( $fields as $field ) : ?>
                <div class="directorist-advanced-filter__advanced__element directorist-search-field-<?php echo esc_attr( $field['widget_name'] )?>" <?php echo isset( $field['class'] ) && ! empty( $field['class'] ) ? esc_attr( $field['class'] ) : ''; ?>>

			...
			<?php if ( $listing->author_has_socials() ): ?>
				...
				<ul class="directorist-author-social">
					...
					<?php if ( $twitter = $listing->author_info( 'twitter' ) ): ?>
						<li class="directorist-author-social-item twitter-square-icon"><a target="_blank" href="<?php echo esc_url( $twitter ); ?>"><?php directorist_icon( 'lab la-twitter-square' ); ?></a></li>
					<?php endif; ?>
                    ...
                    <?php if ( $instagram = get_user_meta( $author_id, 'atbdp_instagram', true ) ): ?>
						<li class="directorist-author-social-item"><a target="_blank" href="<?php echo esc_url( $instagram ); ?>"><?php directorist_icon( 'lab la-instagram' ); ?></a></li>
					<?php endif; ?>

										...
										<?php if( $authors->display_social_info() ): ?>
											...
											<ul class="directorist-author-social directorist-author-social--light">
												...
												<?php if( $twitter = Helper::user_info( $author, 'twitter' ) ): ?>
													<li class="directorist-author-social-item twitter-square-icon">
														<a target="_blank" href="<?php echo esc_url( $twitter ); ?>"><?php directorist_icon( 'lab la-twitter-square' ); ?></a>
													</li>
												<?php endif; ?>
                                                ...
                                                <?php if( $instagram = get_user_meta( $author->data->ID, 'atbdp_instagram', true ) ): ?>
													<li class="directorist-author-social-item">
														<a target="_blank" href="<?php echo esc_url( $instagram ); ?>"><?php directorist_icon( 'lab la-instagram' ); ?></span></a>
													</li>
												<?php endif; ?>

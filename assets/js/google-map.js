    ...
    if ($('#gmap').length) {
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('gmap'), {
          ...
          mapId: directorist_options.google_map_id || 'add_listing_map'
        });
        var marker = new google.maps.marker.AdvancedMarkerElement({
          map: map,
    ...
    if ($('#gmap-widget').length) {
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById(map_container), {
          zoom: loc_map_zoom_level,
          center: saved_lat_lng,
          mapId: directorist_options.google_map_id || 'single_listing_map_widget'
        });
        var marker = new google.maps.marker.AdvancedMarkerElement({
          map: map,
          position: saved_lat_lng,
      ...
      document.querySelectorAll('.directorist-single-map').forEach(function (mapElm) {
        ...
        function initMap() {
          ...
          map = new google.maps.Map(mapElm, {
            zoom: loc_map_zoom_level,
            center: saved_lat_lng,
            mapId: directorist_options.google_map_id || 'single_listing_map'
          });
          var marker = new google.maps.marker.AdvancedMarkerElement({
            map: map,
            position: saved_lat_lng,
      ...
      (function ($) {
        ...
        function atbdp_rander_map($el) {
          ...
          var args = {
            ...
            mapId: directorist_options.google_map_id || 'all_listings_map'
          };
